...
public class CrystalScannerMk1Item extends Item {

    public CrystalScannerMk1Item(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResult useOn(UseOnContext pContext) {
        if(pContext.getLevel().isClientSide()) {
            ...
            if(!foundCrystal) {
                player.sendMessage(new TranslatableComponent("item.advanced_crystals.crystal_scanner_mk1.no_crystal"),
                        player.getUUID());
            }
