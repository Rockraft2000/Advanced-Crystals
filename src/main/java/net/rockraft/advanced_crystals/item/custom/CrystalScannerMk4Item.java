...
public class CrystalScannerMk4Item extends Item {

    public CrystalScannerMk4Item(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResult useOn(UseOnContext pContext) {
        if(pContext.getLevel().isClientSide()) {
            ...
            if(!foundCrystal) {
                player.sendMessage(new TranslatableComponent("item.advanced_crystals.crystal_scanner_mk4.no_crystal"),
                        player.getUUID());
            }
