...
public class CrystalScannerMk2Item extends Item {

    public CrystalScannerMk2Item(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResult useOn(UseOnContext pContext) {
        if(pContext.getLevel().isClientSide()) {
            ...
            if(!foundCrystal) {
                player.sendMessage(new TranslatableComponent("item.advanced_crystals.crystal_scanner_mk2.no_crystal"),
                        player.getUUID());
            }
