...
public class CrystalScannerMk3Item extends Item {

    public CrystalScannerMk3Item(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResult useOn(UseOnContext pContext) {
        if(pContext.getLevel().isClientSide()) {
            ...
            if(!foundCrystal) {
                player.sendMessage(new TranslatableComponent("item.advanced_crystals.crystal_scanner_mk3.no_crystal"),
                        player.getUUID());
            }
